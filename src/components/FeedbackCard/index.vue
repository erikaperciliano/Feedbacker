  ...
  >
    <div class="flex items-center justify-between w-full mb-8">
      ...
      <span class="font-regular text-brand-graydark">
        {{ getDiffTimeBetweenCurrent(feedback.createdAt) }}
      </span>
    </div>
    ...
    :class="{ animate__fadeOutUp: state.isClosing }"
      class="flex mt-8 animate__animated__fodeInUp animate__faster"
      v-if="state.isOpen"
    >
      <div class="felx flex-col w-1/2">
...
import getDiffTimeBetweenCurrent from '../../utils/getDiffTimeBetweenCurrentDate'
