    ...
    <form @submit.prevent="handleSubmit">
      <label class="block">
        ...
        <input
          ...
          class="block w-full px-4 py-3 mt-1 text-lg bg-gray-100 border-2 border-tranparent rounded"
...
export default {
  ...
  setup () {
    ...
    } = useField('nameValue', validateEmptyAndLength3)
    ...
    async function handleSubmit () {
      try {
        toast.clear() // remove the available toasts and put a new one
